...
class NonFatalException extends Exception {
     ...
     * happens This is the protected, complete version
     *
     * @param message The message that identifies what went wrong, specifically
     * @param cause The cause this error was thrown. WE NEED THIS (even though
    ...
    /**
     * A generic, non-fatal exception. We can get back on our feet after this
     * happens We can suppress this one, always. StackTrace is read-only though.
     *
     * @param message The message that identifies what went wrong, specifically
     * @param cause The cause this error was thrown. WE NEED THIS (even though
     * it's probably an IOException)
    ...
    /**
     * Something went horribly wrong. Someone provided no details and expects we
     * can still recover from this. Nope, FATAL EXCEPTION INCOMING
     *
